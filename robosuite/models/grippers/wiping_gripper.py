...
class WipingGripperVX300S(GripperModel):
    """
    Wiping tool MJCF oriented for ViperX 300S (see ``wiping_gripper_vx300s.xml``).
    ...
    def __init__(self, idn=0):
        super().__init__(xml_path_completion("grippers/wiping_gripper_vx300s.xml"), idn=idn)
